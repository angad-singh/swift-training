...
// 1
var shopItemsArray: Array<String> = ["Gold", "Sword", "Axe", "Shield"]
...
// 2
shopItemsArray.contains("Bow and Arrow")

// 3
shopItemsArray.insert("Bow and Arrow", at: 1)
...
// 6
var fullArmorSet: Set<String> = ["forged steel", "iron", "dragon skin", "leather"]
var currentArmorSet: Set<String> = ["forged steel", "dragon skin"]

// 7
var missingItems: Set<String> = fullArmorSet.subtracting(currentArmorSet)

// 8
var armorPieceTuple = (name: "Dragon Skin", cost: 1000, canEquip: true)
